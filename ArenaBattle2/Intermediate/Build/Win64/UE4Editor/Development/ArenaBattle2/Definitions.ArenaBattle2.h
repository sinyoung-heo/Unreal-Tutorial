...
#define UE_PROJECT_NAME ArenaBattle2
#define UE_TARGET_NAME ArenaBattle2Editor
#define UE_MODULE_NAME "ArenaBattle2"
...
#define ARENABATTLE2_API DLLEXPORT
